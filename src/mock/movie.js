...
export const generateMovie = () => ({
  ...
  totalRating: getRandomDecimal(1, 9, 2),
  director: getRandomArrayElement(PEOPLE),
  writers: getRandomArrayElement(PEOPLE),
  actors: getRandomArrayElement(PEOPLE),
  release: generateDate(),
  runtime: generateRunningTime(),
  releaseCountry: getRandomArrayElement(COUNTRIES),
  genre: getRandomArrayElements(GENRES, getRandomInteger(1, 4)),
